...
describe('Blog e2e test', () => {
  ...
  it('should create an instance of Blog', () => {
    ...
    cy.get(`[data-cy="name"]`)
      .type('architectures Asistente Mascotas', { force: true })
      .invoke('val')
      .should('match', new RegExp('architectures Asistente Mascotas'));

    cy.get(`[data-cy="handle"]`).type('Interno uniforme', { force: true }).invoke('val').should('match', new RegExp('Interno uniforme'));
