...
describe('Post e2e test', () => {
  ...
  it('should create an instance of Post', () => {
    ...
    cy.get(`[data-cy="title"]`)
      .type('Marroquinería Ensalada radical', { force: true })
      .invoke('val')
      .should('match', new RegExp('Marroquinería Ensalada radical'));
    ...
    cy.get(`[data-cy="date"]`).type('2021-05-20T21:11').invoke('val').should('equal', '2021-05-20T21:11');
